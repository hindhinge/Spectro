...
class Xaxis(Widget):
    def __init__(self,parent, **kwargs):
        ...
        self.layout_xaxis.add_widget(NumberGenerator(self.WINDOW_WIDTH,35,self.WINDOW_HEIGHT,self.SPEC_LINEWIDTH,self.OPTIONS_WIDTH,self.TIMEFRAME))
        self.layout_xaxis.add_widget(Ruler(self.WINDOW_WIDTH,15,self.WINDOW_WIDTH,self.WINDOW_HEIGHT,self.SPEC_LINEWIDTH,self.OPTIONS_WIDTH,self.TIMEFRAME))
